...
class UpdateEventCopyWidget extends StatefulWidget {
  const UpdateEventCopyWidget({Key? key}) : super(key: key);

  @override
  _UpdateEventCopyWidgetState createState() => _UpdateEventCopyWidgetState();
}

class _UpdateEventCopyWidgetState extends State<UpdateEventCopyWidget> {
