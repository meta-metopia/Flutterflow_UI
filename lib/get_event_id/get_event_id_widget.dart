...
class GetEventIdWidget extends StatefulWidget {
  const GetEventIdWidget({Key? key}) : super(key: key);

  @override
  _GetEventIdWidgetState createState() => _GetEventIdWidgetState();
}

class _GetEventIdWidgetState extends State<GetEventIdWidget> {
                      ...
                      Expanded(
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final dataTableGeteventbyidResponse =
                                snapshot.data!;
                            return Builder(
                              builder: (context) {
                                      ...
                                      .mapIndexed((itemsIndex, itemsItem) => [
                                            FutureBuilder<ApiCallResponse>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final textGeteventbyidResponse =
                                                    snapshot.data!;
                                                return Text(
                                                  getJsonField(
                                                    itemsItem,
