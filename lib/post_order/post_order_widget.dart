...
class PostOrderWidget extends StatefulWidget {
  const PostOrderWidget({Key? key}) : super(key: key);

  @override
  _PostOrderWidgetState createState() => _PostOrderWidgetState();
}

class _PostOrderWidgetState extends State<PostOrderWidget> {
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    'Type merchant ID of order here...',
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText2,
                                                enabledBorder:
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              apiResultmsg = await OrderGroup
                                                  .postorderCall
                                                  .call(
                                                merchantId:
                                                    textController!.text,
                                              );
                                              if ((apiResultmsg?.succeeded ??
                                                  true)) {
                                                await showDialog(
                                                  context: context,
                                                  builder:
